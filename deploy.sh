...
kubectl set image deployments/server-deployment client=chrishao/multi-server:$SHA

kubectl set image deployments/client-deployment client=chrishao/multi-client:$SHA

kubectl set image deployments/worker-deployment client=chrishao/multi-worker:$SHA